                    ...
                    <div class="card" style="background-color:#95ecd4;">
                      ...
                      <div class="card-body card-block">
						  ...
						  <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="BuyerCode" name="BuyerCode" placeholder="Buyer Code" class="form-control"></div>
                          </div>
						...
						<div class="row form-group">
						  ...
						  <div class="row form-group">
                            ...
                            <div class="col-12 col-md-5"><input type="text" id="npp" name="npp" value="NPP-<?php echo (rand(100,9999)); ?>" class="form-control"></div>
							<div class="col-12 col-md-4"><input type="text" id="nbp" name="nbp" value="NBP-<?php echo (rand(100,9999)); ?>" class="form-control"></div>
						  ...
						  <div class="row form-group">
                            ...
                            <div class="col-12 col-md-5"><input type="text" name="nppLimit" placeholder="Enter Npp Limit" class="form-control"></div>
							<div class="col-12 col-md-4"><input type="text" name="nbpLimit" placeholder="Enter Nbp Limit" class="form-control"></div>
