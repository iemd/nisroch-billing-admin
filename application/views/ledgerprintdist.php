...
<body>
<div class="body">
<?php foreach($LedgerPrintDistributor as $row){
//print_r($row);
 }
...
<a id="printPageButton" href="
<?php
  if(!empty($DistributorID) && !empty($DateFrom) && !empty($DateTo)){
      echo base_url('Inventory/LedgerDistributor/').$DistributorID.'/'.$DateFrom.'/'.$DateTo;
    }elseif(!empty($DistributorID) && !empty($DateFrom)){
     echo base_url('Inventory/LedgerDistributor/').$DistributorID.'/'.$DateFrom;
   }elseif(!empty($DistributorID)){
     echo base_url('Inventory/LedgerDistributor/').$DistributorID;
   }else{
     echo '#';
   }
